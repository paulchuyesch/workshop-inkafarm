...
Ruta en el repositorio: [`projects/project-02/`](/projects/project-02)

| Directorio | Qué contiene | Qué comparar |
|------|------|------|
| [`starter/`](/projects/project-02/starter) | Código de Project 01 con importación, vista de detalle y persistencia todavía incompletas. La documentación existe, pero es más ligera y no hay `session-handoff.md`. | Cuánto contexto tiene que redescubrir una segunda sesión del agente. |
| [`solution/`](/projects/project-02/solution) | La misma porción de producto ya completada, con documentación de handoff bajo [`projects/project-02/solution/`](/projects/project-02/solution), además de [`feature_list.json`](/projects/project-02/solution/feature_list.json) y [`session-handoff.md`](/projects/project-02/solution/session-handoff.md). | Si una sesión nueva puede continuar solo desde el estado del repositorio. |
