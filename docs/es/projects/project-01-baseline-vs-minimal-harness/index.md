...
- ChatGPT Code o Codex (elige uno y úsalo en ambas ejecuciones)
...
Ruta en el repositorio: [`projects/project-01/`](/projects/project-01)

| Directorio | Qué contiene | Cómo usarlo |
|------|------|------|
| [`starter/`](/projects/project-01/starter) | Ejecución con harness débil. Solo tiene [`task-prompt.md`](/projects/project-01/starter/task-prompt.md) como descripción de tarea y no incluye `AGENTS.md` ni `feature_list.json`. | Entrega el prompt a tu agente y mide qué completa sin estructura adicional. |
| [`solution/`](/projects/project-01/solution) | El mismo slice del producto con artefactos de harness explícitos: [`AGENTS.md`](/projects/project-01/solution/AGENTS.md), [`CLAUDE.md`](/projects/project-01/solution/CLAUDE.md), [`init.sh`](/projects/project-01/solution/init.sh), [`feature_list.json`](/projects/project-01/solution/feature_list.json) y [`chatgpt-progress.md`](/projects/project-01/solution/chatgpt-progress.md). | Compara cómo las reglas y la verificación convierten la misma tarea en algo ejecutable y comprobable. |
