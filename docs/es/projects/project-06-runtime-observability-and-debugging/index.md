...
Ruta en el repositorio: [`projects/project-06/`](/projects/project-06)

| Directorio | Qué contiene | Qué comparar |
|------|------|------|
| [`starter/`](/projects/project-06/starter) | Producto casi completo, pero con superficie de harness debilitada: [`AGENTS.md`](/projects/project-06/starter/AGENTS.md) básico, sin `feature_list.json`, `session-handoff.md`, checklist de estado limpio ni scripts de benchmark/cleanup. | Observaciones manuales de la línea base con harness débil. |
| [`solution/`](/projects/project-06/solution) | Harness completo: [`AGENTS.md`](/projects/project-06/solution/AGENTS.md), [`CLAUDE.md`](/projects/project-06/solution/CLAUDE.md), [`feature_list.json`](/projects/project-06/solution/feature_list.json), [`init.sh`](/projects/project-06/solution/init.sh), [`session-handoff.md`](/projects/project-06/solution/session-handoff.md), [`clean-state-checklist.md`](/projects/project-06/solution/clean-state-checklist.md), documentos de calidad/evaluación y scripts. | Ejecutar [`projects/project-06/solution/scripts/benchmark.sh`](/projects/project-06/solution/scripts/benchmark.sh) y [`projects/project-06/solution/scripts/cleanup-scanner.sh`](/projects/project-06/solution/scripts/cleanup-scanner.sh), y comparar la evidencia de calidad. |
