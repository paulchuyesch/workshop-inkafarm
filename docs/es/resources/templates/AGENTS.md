...
2. Lee `chatgpt-progress.md` para el estado verificado más reciente y el próximo paso.
...
- `chatgpt-progress.md`: registro de sesión y estado verificado actual
...
- la evidencia está registrada en `feature_list.json` o `chatgpt-progress.md`
...
1. Actualiza `chatgpt-progress.md`.
